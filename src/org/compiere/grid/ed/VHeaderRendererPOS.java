...
import org.compiere.minigrid.MiniTablePOS;
...
public final class VHeaderRendererPOS implements TableCellRenderer, MouseListener, ChangeListener 
{
	 ...
	 */	
	public VHeaderRendererPOS(boolean multiSelection)
	{
		super();
	 ...
	 * @param mField
	 */
	public VHeaderRendererPOS(GridField mField) {
		super();
		//	Alignment
	 ...
	 *  @param displayType
	 */
	public VHeaderRendererPOS(int displayType)
	{
		super();
		//	Alignment
	  ...
	  {  
	    public void itemStateChanged(ItemEvent e) {  
	      ...
	      ((MiniTablePOS) m_table).fireRowSelectionEvent();
	    }
	  }

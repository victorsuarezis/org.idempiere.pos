 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: VNumberPOS.java,v 1.2 2006/07/30 00:51:27 jjanke Exp $
 * 
 ...
 */
public final class VNumberPOS extends JComponent
	implements VEditor, ActionListener, KeyListener, FocusListener, VManagedEditor
{
	...
	final class VNumber_mouseAdapter extends MouseAdapter
	{
		/**
		 *	Constructor
		 *  @param vNumberPOS adaptee
		 */
		VNumber_mouseAdapter(VNumberPOS vNumberPOS)
		{
			m_adaptee = vNumberPOS;
		}	//	VNumber_mouseAdapter

		private VNumberPOS m_adaptee;
	 ...
	 *  @param title title
	 */
	public VNumberPOS(String columnName, boolean mandatory, boolean isReadOnly, boolean isUpdateable,
	...
	public void actionPerformed (ActionEvent e)
	{
		...
		else if (e.getActionCommand().equals(RecordInfoPOS.CHANGE_LOG_COMMAND))
		{
			RecordInfoPOS.start(m_mField);
			return;
		}
	...
	public void setField (GridField mField)
	{
		...
		if (m_mField != null)
			RecordInfoPOS.addMenu(this, popupMenu);
	}   //  setField

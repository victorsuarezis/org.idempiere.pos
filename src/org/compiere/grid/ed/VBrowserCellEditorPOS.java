 ...
 */
public final class VBrowserCellEditorPOS extends AbstractCellEditor
     ...
     * Logger
     */
    private static CLogger log = CLogger.getCLogger(VBrowserCellEditorPOS.class);
    int row = -1;
    int col = -1;
    /**
     * The Field
     ...
     * @param mField
     */
    public VBrowserCellEditorPOS(GridField mField) {
        super();
        m_mField = mField;
        //  Click
    }    //	VCellEditor
    ...
    private void createEditor() {
        m_editor = VEditorFactoryPOS.getEditor(m_mField, true);

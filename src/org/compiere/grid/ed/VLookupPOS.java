	...
	implements VEditor, ActionListener, FocusListener
{
	...
	final class VLookup_mouseAdapter extends java.awt.event.MouseAdapter
	{
		/**
		 *	Constructor
		 *  @param vLookupPOS adaptee
		 */
		VLookup_mouseAdapter(VLookupPOS vLookupPOS)
		{
			m_adaptee = vLookupPOS;
		}	//	VLookup_mouseAdapter

		private VLookupPOS m_adaptee;
	 ...
	 *  @param lookup lookup
	 */
	public VLookupPOS (String columnName, boolean mandatory, boolean isReadOnly, boolean isUpdateable,
		Lookup lookup)
	{
		super();

 ...
 */
public class RecordInfoPOS extends RecordInfoController
{
	 ...
	 */
	private RecordInfoPOS (Frame owner, String title, DataStatusEvent dse, GridField mField)
	{
		//	Load super
	 ...
	 * @param dse
	 */
	public RecordInfoPOS (Frame owner, String title, DataStatusEvent dse) {
	 ...
	 * @param mField
	 */
	public RecordInfoPOS (Frame owner, GridField mField) {

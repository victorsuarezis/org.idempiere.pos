...
public class X_AD_Browse_Field extends PO implements I_AD_Browse_Field, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20170522L;
	...
	/** Set AD_Browse_Field_ID.
		@param AD_Browse_Field_UU AD_Browse_Field_ID	  */
	public void setAD_Browse_Field_UU (String AD_Browse_Field_UU)
	{
		set_ValueNoCheck (COLUMNNAME_AD_Browse_Field_UU, AD_Browse_Field_UU);
	}

	/** Get AD_Browse_Field_ID.
		@return AD_Browse_Field_ID	  */
	public String getAD_Browse_Field_UU () 
	{
		return (String)get_Value(COLUMNNAME_AD_Browse_Field_UU);
	}
	...
	public org.compiere.model.I_AD_ViewColumn getAD_ViewColumn() throws RuntimeException
    {
		return (org.compiere.model.I_AD_ViewColumn)MTable.get(getCtx(), org.compiere.model.I_AD_ViewColumn.Table_Name)
			.getPO(getAD_ViewColumn_ID(), get_TrxName());	}
	...
	public org.compiere.model.I_AD_ViewColumn getAxis_Column() throws RuntimeException
    {
		return (org.compiere.model.I_AD_ViewColumn)MTable.get(getCtx(), org.compiere.model.I_AD_ViewColumn.Table_Name)
			.getPO(getAxis_Column_ID(), get_TrxName());	}

	/** Set Axis Column.
		@param Axis_Column_ID Axis Column	  */
	...
	/** Set Axis Parent Column.
		@param Axis_Parent_Column_ID Axis Parent Column	  */

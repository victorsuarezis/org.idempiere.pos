...
public class X_AD_View extends PO implements I_AD_View, I_Persistent 
{
	...
	/** Set AD_View_UU.
		@param AD_View_UU AD_View_UU	  */
	public void setAD_View_UU (String AD_View_UU)
	{
		set_Value (COLUMNNAME_AD_View_UU, AD_View_UU);
	}

	/** Get AD_View_UU.
		@return AD_View_UU	  */
	public String getAD_View_UU () 
	{
		return (String)get_Value(COLUMNNAME_AD_View_UU);
	}

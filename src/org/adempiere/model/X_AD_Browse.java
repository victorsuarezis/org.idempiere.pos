...
// 3
	...
	/** Set Smart Browse.
		@param AD_Browse_UU Smart Browse	  */
	public void setAD_Browse_UU (String AD_Browse_UU)
	{
		set_Value (COLUMNNAME_AD_Browse_UU, AD_Browse_UU);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_AD_Browse_UU);
	}
    ...
    {
		return (I_AD_View)MTable.get(getCtx(), I_AD_View.Table_Name)
	...
	/** Set Collapsible By Default.
		@param IsCollapsibleByDefault Collapsible By Default	  */
	...
	/** Get Collapsible By Default.
		@return Collapsible By Default	  */
	...
	/** Set Executed Query By Default.
		@param IsExecutedQueryByDefault Executed Query By Default	  */
	...
	/** Get Executed Query By Default.
		@return Executed Query By Default	  */
	...
	/** Set Selected By Default.
		@param IsSelectedByDefault Selected By Default	  */

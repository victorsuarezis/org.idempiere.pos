...
public abstract class SmallViewController implements SmallViewEditable, VetoableChangeListener, PropertyChangeListener, ValueChangeListener {
	 ...
	 */
	public abstract CEditorPOS createEditor(GridField field);
...
//			}
	...
	private void createEditors(GridField field, GridField fieldTo) {
		...
		//  a reference to it.
		CEditorPOS editor = createEditor(field);
		...
		CEditorPOS editorTo = createEditor(fieldTo);
		...
		//  GridFields use PropertyChange events to propagate changes
		//  back to the editors and controller.
		fieldTo.addPropertyChangeListener((PropertyChangeListener) editorTo);
	...
	public void vetoableChange(PropertyChangeEvent evt) throws PropertyVetoException {
		...
		if (evt.getSource() instanceof CEditorPOS) {
			changedField = ((CEditorPOS) evt.getSource()).getField();
		}
		else
			return;

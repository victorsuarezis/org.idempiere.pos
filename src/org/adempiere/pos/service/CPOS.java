...
public class CPOS {
	...
	/**	POS Configuration		*/
	private org.idempiere.model.MPOS 				entityPOS;
	/**	Current Order			*/
	...
	public void setPOS(int salesRepId) {
		...
		List<org.idempiere.model.MPOS> poss = getPOSByOrganization(Env.getAD_Org_ID(getCtx()));
		//
		if (poss.size() == 0) {
	 ...
	 * @return MPOS
	 */
	public org.idempiere.model.MPOS getM_POS() {
		return entityPOS;
	}
	 ...
	 *	@return array of POS
	 */
	public List<org.idempiere.model.MPOS> getPOSByOrganization (int orgId) {
		return org.idempiere.model.MPOS.getByOrganization(ctx, orgId, null);
	}
	...
	public BigDecimal getAmountReceived()
	{
		...
		for (MPayment payment : MPaymentPOS.getOfOrder(getOrder()))
	...
	public ValueNamePair[] getCreditCards (BigDecimal amt) {
		try {
			MPaymentProcessor[] paymentProcessors = MPaymentProcessorPOS.find (Env.getCtx(), null, null,

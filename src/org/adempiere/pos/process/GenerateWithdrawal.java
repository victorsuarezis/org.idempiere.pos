...
public class GenerateWithdrawal extends GenerateWithdrawalAbstract {
    ...
    private String getSelectionAsString(int get_ID, String string) {
		// TODO Auto-generated method stub
    	System.out.println("Method not implemented yet");
		return null;
	}

	private BigDecimal getSelectionAsBigDecimal(int get_ID, String string) {
		// TODO Auto-generated method stub
		System.out.println("Method not implemented yet");
		return null;
	}

	private List<MRefList> getInstancesForSelection(String get_TrxName) {
		// TODO Auto-generated method stub
    	System.out.println("Method not implemented yet");
		return null;
	}
            ...
            Integer paymentBatchId)
    {
            ...
            payment.set_ValueOfColumn(MColumn.getColumn_ID(MPayment.Table_Name, "C_POS_ID"), pOSTerminalId);

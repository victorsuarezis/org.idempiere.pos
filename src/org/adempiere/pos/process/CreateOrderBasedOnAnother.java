...
public class CreateOrderBasedOnAnother extends CreateOrderBasedOnAnotherAbstract {
    ...
    protected String doIt() throws Exception {
        ...
        if (getSOSubType() != null)
            targetOrder.setC_DocTypeTarget_ID(MDocTypePOS.getDocTypeBaseOnSubType(sourceOrder.getAD_Org_ID() , MDocType.DOCBASETYPE_SalesOrder , getSOSubType()));
    ...
    private void createAllocations(MOrder targetOrder) {
        List<MPayment> payments = MPaymentPOS.getOfOrder(targetOrder);
    ...
    {
        for (MPayment sourcePayment : MPaymentPOS.getOfOrder(sourceOrder))
        {
            ...
            payment.setC_DocType_ID(MDocTypePOS.getDocType(MDocType.DOCBASETYPE_ARReceipt, sourceOrder.getAD_Org_ID()));

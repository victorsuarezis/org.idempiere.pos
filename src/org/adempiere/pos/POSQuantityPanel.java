...
import org.compiere.grid.ed.VNumberPOS;
...
public class POSQuantityPanel extends POSSubPanel implements POSPanelInterface, ActionListener {
	...
	private VNumberPOS 			fieldPrice;
	private VNumberPOS 			fieldDiscountPercentage;
	private VNumberPOS 			fieldQuantity;
	...
	protected void init() {
		...
		fieldDiscountPercentage = new VNumberPOS();
